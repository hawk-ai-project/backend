...
from controller import admin_controller, auth_controller, board_controller, chat_controller, file_controller, inspection_controller, menu_controller, question_controller
